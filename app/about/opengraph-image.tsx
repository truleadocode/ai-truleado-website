...
export const alt = "About Truleado — Built by Someone Who's Been on Both Sides"
  ...
  return new ImageResponse(
    (
      <div style={{ background: '#0E0E11', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '80px', fontFamily: 'serif', position: 'relative' }}>
        <div style={{ color: '#9894CC', fontSize: 14, letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: 24, display: 'flex' }}>Our story</div>
        ...
        <div style={{ color: '#888', fontSize: 22, lineHeight: 1.6, maxWidth: 640, display: 'flex' }}>
          Peter Hall built Truleado to fix influencer marketing&apos;s matching problem.
        </div>
        <div style={{ position: 'absolute', bottom: 40, right: 60, color: '#444', fontSize: 14, display: 'flex' }}>truleado.com/about</div>
      </div>
    ),
    { ...size }
  )
