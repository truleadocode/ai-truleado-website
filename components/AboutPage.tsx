  ...
  return (
    <>
      ...
      <div className="pt-[128px] px-10 pb-0 max-w-[1060px] mx-auto max-[900px]:px-5">
        <p
          className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.15em] uppercase mb-5"
          style={{ color: 'var(--acc)' }}
        >
        ...
        <h1
          className="font-extrabold tracking-[-2.5px] leading-[1.04] max-w-[700px] mb-7"
      ...
      <div className="max-w-[1060px] mx-auto px-10 py-[72px] max-[900px]:px-5">
        <div
          className="grid gap-16 items-start max-[900px]:grid-cols-1"
        ...
        >
          ...
          <div>
            ...
            >
              <div
                className="w-full aspect-square flex items-center justify-center text-[56px] font-extrabold tracking-[-2px]"
                style={{
                  background: 'var(--bg3)',
                  color: 'var(--acc)',
              ...
              <div className="px-[22px] pt-5 pb-6">
                <p className="text-[16px] font-bold mb-[3px]">Peter Hall</p>
                <p className="text-[13px] font-normal mb-4" style={{ color: 'var(--muted)' }}>
          ...
          <div>
            <h2
              className="font-extrabold tracking-[-1px] leading-[1.1] mb-6"
              style={{ fontSize: 'clamp(22px, 3vw, 34px)' }}
            >
              Influencer marketing works.<br />The process around it doesn&apos;t.
            </h2>
            <p className="text-[16px] font-normal leading-[1.8] mb-5" style={{ color: 'var(--muted)' }}>
            ...
            <p className="text-[16px] font-normal leading-[1.8]" style={{ color: 'var(--muted)' }}>
      ...
      <div className="max-w-[1060px] mx-auto px-10 pb-[88px] pt-0 max-[900px]:px-5">
        <p
          className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.15em] uppercase mb-[14px] mt-[72px]"
          style={{ color: 'var(--acc)' }}
        >
          <span className="w-[18px] h-0.5 rounded-sm inline-block" style={{ background: 'var(--acc)' }} />
          What we believe
        ...
        <h2
          className="font-extrabold tracking-[-1.5px] leading-[1.07] max-w-[440px] mb-10"
          style={{ fontSize: 'clamp(26px, 3.5vw, 44px)' }}
        >
          The principles<br />behind everything.
        </h2>
        <div
          className="grid gap-[14px] max-[900px]:grid-cols-1"
        ...
        >
          {values.map(v => (
            ...
            >
              <p
                className="text-[11px] font-bold tracking-[0.12em] mb-[14px]"
                style={{ color: 'var(--acc)' }}
              >
                {v.n}
              </p>
              <h3 className="text-[15px] font-bold mb-2">{v.title}</h3>
              <p className="text-[14px] font-normal leading-[1.7]" style={{ color: 'var(--muted)' }}>
                {v.body}
              </p>
            </div>
          ))}
